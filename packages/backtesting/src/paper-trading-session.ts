...
function accountingFor(candles: readonly StrategyCandle[], fills: ReturnType<typeof generateStrategyFills>, initialCapital: number, allowShort: boolean | undefined): PortfolioAccountingResult { return allowShort === undefined ? accountFills(candles, fills, initialCapital) : accountFills(candles, fills, initialCapital, { allowShort }); }
